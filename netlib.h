...
void Listen2(int fd, int backlog,struct addrinfo *res);
...
int
server_socket(const char *,const char *);


size_t
mystrlcat(char *, const char *, size_t);



//ssize_t						/* Write "n" bytes to a descriptor. */
void
sending(int , const void *, size_t ,int);

void
Accept_loop(int , socklen_t );
...
int
client_socket(const char *, const char *);

void
client_snd_recv_loop(int );
...
int
Client_socket6(const char *, const char *);

int
Client_socket4(const char *, const char *);

int
Set_block(int, int);

int
client_socket_with_timout(const char *, const char *, int );

int
tcp_connect_with_timeout(const char *, const char *,int);
...
int
Makesocket(const char * , const char *);

void
poll_accept_loop(int);
